...
class SVGZygalskiSheet:
    ...
    LETS_LEFT_OFFSET = -17
    LETS_RIGHT_OFFSET = (CELL_SIZE * 52) + 9
    LETS_TOP_OFFSET = -3.5 * 2
    LETS_BOTTOM_OFFSET = (CELL_SIZE * 52) + 16
    ...
    def _render_letters(self):
        ...
        for i in range(26):
            ...
            self.svg += self._render_letter(self.LETS_LEFT_OFFSET,((i+26)*24) + 18,l)
            self.svg += self._render_letter(self.LETS_RIGHT_OFFSET,(i*24) + 18,l)
            self.svg += self._render_letter(self.LETS_RIGHT_OFFSET,((i+26)*24) + 18,l)
            self.svg += self._render_letter((i*24) + 8,self.LETS_TOP_OFFSET,l)
            self.svg += self._render_letter(((i+26)*24) + 8,self.LETS_TOP_OFFSET,l)
            self.svg += self._render_letter((i*24) + 8,self.LETS_BOTTOM_OFFSET,l)
            self.svg += self._render_letter(((i+26)*24) + 8,self.LETS_BOTTOM_OFFSET,l)
    ...
    def cells_rect_size(cls):
        ...
        """
        #return ((cls.CELL_SIZE - cls.CELL_BORDER_WIDTH) * 52) + cls.CELL_BORDER_WIDTH
        return (cls.CELL_SIZE  * 52) + cls.CELL_BORDER_WIDTH
